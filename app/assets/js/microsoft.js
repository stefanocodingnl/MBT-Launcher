...
// Constants
const clientId = '1c4e72f8-be8a-4eae-88bc-382e1a27c06b'
        ...
        requestPromise(authXSTSUri, options).then(response => {
            if (response.body.XErr) {
                switch (response.body.XErr) {
                    ...
                    case 2148916238: 
                        reject({
                            message: 'Since you are not yet 18 years old, an adult must add you to a family in order for you to use MBT-Pack!'
                        })
                        return
